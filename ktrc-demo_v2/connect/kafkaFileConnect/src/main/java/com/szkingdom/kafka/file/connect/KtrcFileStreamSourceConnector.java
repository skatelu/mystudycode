...
public class KtrcFileStreamSourceConnector extends SourceConnector {
    ...
    public void start(Map<String, String> props) {
        ...
        if (topics.size() != 1) {
            throw new ConfigException("'topic' in KtrcFileStreamSourceConnector configuration requires definition of a single topic");
        }
        topic = topics.get(0);
...
//            this.context.requestTaskReconfiguration();
    ...
    public Class<? extends Task> taskClass() {
        return KtrcFileStreamSourceTask.class;
    }
    ...
    @Override
    public void stop() {
        // Nothing to do since KtrcFileStreamSourceConnector has no background monitoring.
    }
