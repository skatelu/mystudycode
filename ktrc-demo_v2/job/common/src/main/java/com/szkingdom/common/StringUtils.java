...
public class StringUtils {
	 ...
	 *
	 * @param string *格式 AVAILABLE:11.5,TRD_FRZ:12,OUTSTANDING:34,OTD_AVL:26.8
	 * @param  field
	 * @return
	 */
	public static String getFieldStrValue(String strInfo ,String fieldName) {

		if (strInfo != null &&  !strInfo.isEmpty() && strInfo.length() > 0 && fieldName != null &&  !fieldName.isEmpty() && fieldName.length() > 0) {
