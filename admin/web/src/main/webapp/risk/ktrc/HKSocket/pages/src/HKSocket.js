...
define(function (require, exports, module) {
    ...
    var MenuModel = Backbone.Model.extend({
        ...
        getTableView: function () {
            ...
            debugger;
            var $table = $("#HKSocketQuery").append($tab);
    ...
    var MenuView = Backbone.View.extend({
        ...
        initialize: function (args) {
            ...
            intervalFlag = setInterval(function () {
            	/*var fullname = $(".datagrid-queryForm").find("input[name=FULLNAME]").val();
            	var fundid = $(".datagrid-queryForm").find("input[name=FUNDID]").val();
            	var market = $(".datagrid-queryForm").find("input[name=MARKET]").val();
