...
define(function(require, exports, module) {
            ...
            commonAdd: function(e, $datagrid, btnConf) {
                ...
                parser.createCommonDialog({
                    ...
                    onSaveSuccess: function(formData) {
                        var render = getElementRender($datagrid);
                        $datagrid[render]("reload", null, function(){
                    ...
                    if(flag) {
                        if(btnConf.req && btnConf.req.length) {
                            ajax.post({
                                ...
                                $datagrid[getElementRender($datagrid)]("reload");
                            });
                        }
                    }
                }, {
    ...
    function getElementRender($el) {
        return $el
        && $el.jquery
        && $el.length
        && !_.isEmpty($el.data()) ? $el.data("treegrid") ? "treegrid" : $el.data("datagrid") ? "datagrid" : Object.keys($el.data())[0] : "";
    }
