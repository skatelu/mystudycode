 ...
 */
define("lib/kui/propertygrid", [], function(require, exports, module) {
    var currTarget;
    ...
    function buildGrid(target) {
        ...
        $(target).datagrid($.extend({}, opts, {
            ...
            onResize: function() {
                resizeGroup(target);
                $.isFunction(opts.onResize) && opts.onResize.apply(this, arguments);
            },
    ...
    function resizeGroup(target) {
        $(target).datagrid("getPanel").find("div.datagrid-view2").find("div.datagrid-group").each(function() {
            var $group = $(this);
            $group.width($group.next().outerWidth());
        });
    }
});
