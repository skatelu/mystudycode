...
define(function(require, exports, module) {
    ...
    function handleCallbacks(viewConf) {
        var commonBtnHandler = {
            ...
            manage: function(e, $datagrid, btnConf) {
                /*var mainDatagridId = $datagrid.data("mainDatagrid"),
                    $mainDatagrid = mainDatagridId ? $("#" + mainDatagridId) : $(),
                    subDatagridId = $datagrid.data("subDatagrid"),
                    $subDatagrid = subDatagridId ? $("#" + subDatagridId) : $(),
            	...
            	window.document.location.href="./test.html"
...
*/            },
    ...
    function onInitSuccess(){
    	 var FACTOR_NAME = $("input[name='FACTOR_NAME']");
    	 FACTOR_NAME.attr('placeholder','请输入因子名称或ID');
    }
 // 暴露函数到外部。
 /*function loadIndicatorType2(){
	 var FACTOR_NAME = $("input[name='FACTOR_NAME']");
	 alert(FACTOR_NAME);
	 FACTOR_NAME.val("请输入因子名称或ID");
    }
    */
    return {
    	$ready : exports.$ready,
    	//loadIndicatorType2:loadIndicatorType2
