...
define(function (require, exports, module) {
    ...
    var MenuModel = Backbone.Model.extend({
        ...
        getTableView: function () {
            ...
            debugger;
            var $table = $("#ZHJDatagrid").append($tab);
    ...
    var MenuView = Backbone.View.extend({
        ...
        initialize: function (args) {
            ...
            intervalFlag = setInterval(function () {
                var fullname = $(".datagrid-queryForm").find("input[name=FUNDID]").val();
                var fundid = $(".datagrid-queryForm").find("input[name=CUSTID]").val();
                var market = $(".datagrid-queryForm").find("input[name=CUSTNAME]").val();
                if(fullname !=''|| fundid !='' || market !=''){
                    clickFlag = false;
                }else{
                    clickFlag = true;
                }
