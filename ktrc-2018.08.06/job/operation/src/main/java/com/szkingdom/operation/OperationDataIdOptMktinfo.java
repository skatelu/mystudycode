 ...
 * FileName: OperationDataIdOptMktinfo
 * Author:   ZhengMingjie
 * Date:     2018/8/27
 * Description: 风控接口期权行情数据类
 * Version:  0.1.0
 * History:
...
public class OperationDataIdOptMktinfo extends OperationBase {
    ...
    public OperationDataIdOptMktinfo() {
        init();
    }

    public OperationDataIdOptMktinfo(JSONObject json) {
    }
