...
public class DataRiskLogCorpFund extends DataBase {

    private static final long serialVersionUID = 5365034551295275530L;
    private long riskLogSn;
    ...
    public DataRiskLogCorpFund(){
    }

    public DataRiskLogCorpFund(JSONObject json){
    }
    ...
    public void setRiskLogSn(long riskLogSn){
        this.riskLogSn = riskLogSn;
    }

    public long  getRiskLogSn(){
        return this.riskLogSn;
    }
